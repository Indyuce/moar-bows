...
public enum DefaultBow {
	...
	HUNTER_BOW("Hunter Bow", new String[] { "Arrows deal 75% additional", "damage to friendly mobs." }, "redstone", 0, new String[] { "RAW_CHICKEN,RAW_BEEF,RAW_CHICKEN", "RAW_BEEF,BOW,RAW_BEEF", "RAW_CHICKEN,RAW_BEEF,RAW_CHICKEN" }, new BowModifier("damage-percent", 75)),
	...
	CUPIDONS_BOW("Cupidon's Bow", new String[] { "Arrows heal players for 3 hearts.", "Also unmarks (&nMarked Bow&7) players." }, "heart", 0, new String[] { "SPECKLED_MELON,SPECKLED_MELON,SPECKLED_MELON", "SPECKLED_MELON,BOW,SPECKLED_MELON", "SPECKLED_MELON,SPECKLED_MELON,SPECKLED_MELON" }, new BowModifier("heal", 4)),
