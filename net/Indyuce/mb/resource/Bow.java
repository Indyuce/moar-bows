...
public enum Bow {
	...
	GRAVITY_BOW("Gravity Bow", new String[] { "Fires arrows that attracts", "your target to yourself." }, "spell_instant", 0, new String[] { "AIR,FISHING_ROD,AIR", "AIR,BOW,AIR", "AIR,AIR,AIR" }, new BowMod("force", 2.5), new BowMod("y-static", .3)),
	...
	PULSAR_BOW("Pulsar Bow", new String[] { "Shoots an arrow that explodes when", "hitting something, powerfully attracting", "enemies within 5 blocks." }, "smoke_normal", 10.0, new String[] { "AIR,SKULL_ITEM:1,AIR", "SKULL_ITEM:1,BOW,SKULL_ITEM:1", "AIR,SKULL_ITEM:1,AIR" }, new BowMod("duration", 3)),
	EARTHQUAKE_BOW("Earthquake Bow", new String[] { "Summons a shockwave when hitting anything,", "powerfully knocking up all", "enemies within 5 blocks." }, "redstone:128,0,0", 10.0, new String[] { "DIRT,DIRT,DIRT", "DIRT,BOW,DIRT", "DIRT,DIRT,DIRT" }, new BowMod("knockup", 1), new BowMod("radius", 5)),;
