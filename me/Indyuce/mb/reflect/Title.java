...
public class Title {
	...
	public static void actionBar(Player p, String msg) {
		try {
			...
			Constructor<?> constructor = RUt.nms("PacketPlayOutChat").getConstructor(RUt.nms("IChatBaseComponent"), (VersionUtils.isBelow(1, 11) ? byte.class : RUt.nms("ChatMessageType")));
			Object titlePacket = constructor.newInstance(chatBar, (VersionUtils.isBelow(1, 11) ? (byte) 2 : RUt.nms("ChatMessageType").getField("GAME_INFO").get(null)));
			RUt.sendPacket(p, titlePacket);
